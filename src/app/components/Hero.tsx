    ...
    return (
        <section className="relative h-[70vh] overflow-hidden">
            <div className="absolute inset-0 z-0">
                <Image src={hero} alt="Lz" className="w-full h-full object-cover" />
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 sm:px-6 xl:px-12">
                ...
                <p className="mt-4 text-[#d1d1d1] text-base sm:text-lg lg:text-xl max-w-2xl">
                    Crafting worlds that doesn't exist - but fell real.
                </p>
                <div className="mt-8">
                    <a href="/products" className="inline-block border border-white text-white px-6 py-3 rounded-md text-sm uppercase tracking-wide hover:bg-white hover:text-black transition-colors">
                    Explore Products
                    </a>
                </div>
            </div>
